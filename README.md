...
Проект создавался для решения одной единственной проблемы - как быстро и удобно организовать встречу группе людей с самыми разными личными графиками?

Идея заключается в возможности вносить свой график, создавать группы, что позволяет графикам участников связываться.
Участники группы видят промежутки времени, в которые у каждого из них нет запланированных мероприятий. Это решает проблемы необходимости договариваться, назначать организатора, дергать друг друга. Достаточно внести свой график, добавить друга и посмотреть, когда можно провести время за встречей)
...
Большинство планировщиков, которые существуют на рынке персональные и не имеют функционала, который мы стараемся реализовать. Если люди видят, что скорее всего встретиться не получается, потому что они построили следующий график, то скорее всего они не будут думать о том, как можно сдвинуть или поменять местами некоторые мероприятия, потому что это очень нудно и займет немало времени, к тому же есть шанс что-то забыть. Приложение способно сделать это за вас).

В дальнейшем можно рекомендовать места, где пользователи могут потратить деньги на досуг (синхронизируясь с геолокацией пользователя).
